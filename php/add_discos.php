     ...
     if (!isset($_POST["nombre"])) : ?>
         <form method="post">
           <fieldset>
             ...
             <span>Año de salida:</span><input type="date" name="fecha_salida" required><br>
             <span>Premios:</span><input type="text" name="premios" required><br>
             <span>Portada:</span><input type="image" name="portada" required><br>
             <span><input type="submit" value="Insertar">
           </fieldset>
         </form>
       ...
       <?php
        ...
        $nombre=$_POST['nombre'];
        $fecha_salida=$_POST['pais'];
        $portada=$_POST['portada'];
        $consulta= "INSERT INTO discos VALUES('','$nombre','$fecha_salida', '$premios', '$portada')";
